...
Java_com_lxk_ndkdemo_JniArrayOperation_getIntArray(JNIEnv *env, jobject instance,
                                                             jint length) {
    //创建一个指定大小的数组
...
Java_com_lxk_ndkdemo_JniArrayOperation_sortIntArray(JNIEnv *env, jobject instance,
                                                              jintArray arr_) {
    //获取数组起始元素的指针
